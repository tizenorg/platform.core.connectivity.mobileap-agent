...
static char *__get_icon_path(mobile_ap_type_e type)
{
	...
	case MOBILE_AP_TYPE_WIFI:
		snprintf(icon_path, MH_NOTI_PATH_MAX, "%s/%s",
				MH_NOTI_ICON_PATH, MH_NOTI_ICON_WIFI);
		break;
	case MOBILE_AP_TYPE_USB:
		snprintf(icon_path, MH_NOTI_PATH_MAX, "%s/%s",
				MH_NOTI_ICON_PATH, MH_NOTI_ICON_USB);
		break;
	case MOBILE_AP_TYPE_BT:
		snprintf(icon_path, MH_NOTI_PATH_MAX, "%s/%s",
				MH_NOTI_ICON_PATH, MH_NOTI_ICON_BT);
		break;
	default:
		snprintf(icon_path, MH_NOTI_PATH_MAX, "%s/%s",
				MH_NOTI_ICON_PATH, MH_NOTI_ICON_GENERAL);
		break;
	}
